...
class __TwigTemplate_9cfcc312ca6b068c71b8edab12a494ac extends Template
{
    ...
    ";
        ...
        ";
        // line 16
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 16, $this->source); })()), "profileImage", [], "any", false, false, false, 16), 'row');
        yield "
        ";
        // line 17
...
";
    ...
    {
        return array (  140 => 21,  136 => 20,  130 => 17,  126 => 16,  123 => 15,  121 => 13,  117 => 12,  113 => 11,  109 => 10,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    {{ form_start(registrationForm) }}
        ...
        {{ form_row(registrationForm.profileImage) }}
...
{% endblock %}
", "registration/register.html.twig", "C:\\wamp64\\www\\Site_Fantasia\\Project_fantasia\\templates\\registration\\register.html.twig");
    }
}
