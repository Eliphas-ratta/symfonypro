...
";
    ...
    <div class=\"row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["heroes"]) || array_key_exists("heroes", $context) ? $context["heroes"] : (function () { throw new RuntimeError('Variable "heroes" does not exist.', 65, $this->source); })()));
