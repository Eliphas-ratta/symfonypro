...
";
    ...
    <div class=\"row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["capacities"]) || array_key_exists("capacities", $context) ? $context["capacities"] : (function () { throw new RuntimeError('Variable "capacities" does not exist.', 65, $this->source); })()));
            ...
            <div class=\"col\">
                <div class=\"card bg-dark text-white border-0 shadow rounded-4 capacity-card position-relative\" id=\"card-{{ capacity.id }}\">
                    ...
                    <div class=\"card-body p-2\">
                        ...
                        <p class=\"card-text text-muted small mb-0\">{{ capacity.Type ?: 'No type' }}</p>
                    </div>
